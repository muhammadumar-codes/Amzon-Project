...
export default function DataContextProvider({ children }) {
  ...
  const Data = [
   ...
   items: [
      { name: "Cleaning Tools", image: "https://picsum.photos/150/150?random=6" },
      { name: "Home Storage", image: "https://picsum.photos/150/150?random=7" },
  ...
  },
  {
    ...
    category: "Electronics",
   items: [
      { name: "Jeans under $50", image: "https://picsum.photos/150/150?random=2" },
      { name: "Tops under $25", image: "https://picsum.photos/150/150?random=3" },
      { name: "Dresses under $30", image: "https://picsum.photos/150/150?random=4" },
      { name: "Shoes under $50", image: "https://picsum.photos/150/150?random=5" },
    ],
  ...
  },
  {
    ...
    reviewsCount: 720,
       items: [
      { name: "Kitchen & Dining", image: "https://picsum.photos/150/150?random=10" },
      { name: "Home Improvement", image: "https://picsum.photos/150/150?random=11" },
      { name: "Décor", image: "https://picsum.photos/150/150?random=12" },
      { name: "Bedding & Bath", image: "https://picsum.photos/150/150?random=13" },
    ],
    category: "Fashion",
  ...
  },
  {
    ...
    description: "Enjoy a cinematic viewing experience with vibrant colors and 4K clarity.",
    prime: true,
    discount: 20
  },
  {
  ...
  },
  {
    ...
    description: "RGB mechanical keyboard with blue switches for responsive gameplay.",
    prime: true,
    discount: 12
  },
  {
  ...
  },
  {
    ...
    description: "Quick boil kettle with auto shut-off and stainless steel body.",
    prime: true,
    discount: 10
  },
  {
  ...
  },
  {
    ...
    description: "Water-resistant backpack with USB charging port and laptop sleeve.",
    prime: true,
    discount: 12
  },
  {
    ...
    description: "Cook crispy fried food with little to no oil using this air fryer.",
    prime: true,
    discount: 18
  },
  {
  ...
  },
  {
    ...
    description: "Lightweight cordless vacuum for quick cleaning around the house.",
    prime: true,
    discount: 15
  },
  {
  ...
  },
  {
    ...
    description: "1080p Wi-Fi camera with motion detection and two-way audio.",
    prime: true,
    discount: 10
  },
  {
  ...
  },
  {
    ...
    description: "Ergonomic wireless keyboard and mouse for seamless productivity.",
    prime: true,
    discount: 9
  },
  {
    ...
    description: "Elegant handbag set with matching clutch and shoulder strap.",
    prime: false,
    discount: 10
  },
  {
  ...
  },
  {
    ...
    description: "Comfortable gaming chair with adjustable armrests and tilt function.",
    prime: true,
    discount: 18
  },
  {
    ...
    description: "Color-changing Wi-Fi bulb controllable via smartphone or voice.",
    prime: true,
    discount: 5
  },
  {
    ...
    description: "Leakproof water bottle with flip-top lid for gym or travel.",
    prime: true,
    discount: 6
  },
  {
  ...
  },
  {
    ...
    description: "Stretchy and comfortable yoga pants for workouts or lounging.",
    prime: true,
    discount: 10
  },
  {
  ...
  },
  {
    ...
    description: "Long-range wireless doorbell with 36 chimes and LED indicator.",
    prime: true,
    discount: 8
  },
  {
  ...
  },
  {
    ...
    description: "Dimmable LED desk lamp with flexible neck and touch controls.",
    prime: true,
    discount: 10
  },
  {
  ...
  },
  {
    ...
    description: "Spacious duffel bag ideal for travel, gym, or weekend trips.",
    prime: true,
    discount: 9
  },
  {
    ...
    description: "Breathable and durable running shoes for everyday training.",
    prime: true,
    discount: 12
  },
  {
  ...
  },
  {
    ...
    description: "Dual-fan cooling pad compatible with laptops up to 17 inches.",
    prime: true,
    discount: 12
  },
  {
